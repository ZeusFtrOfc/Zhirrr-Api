...
try {
var akira = db.get("akira");
} catch (e) {
	console.log('')
}

var creatorList = ['@akiraa','@akiraaa','@youtubeakira','@akira','@akirayt'];
...
loghandler = {
    notparam: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Apikeynyaaa',
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6282158549899 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    notkata: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Kata dengan Tepat!!'
    },
    nottext: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Text dengan Tepat!!'
    },
    nottext2: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Text 2 dengan Tepat!!'
    },
    notnabi: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Nama Nabi'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Text 3 dengan Tepat!!'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
    ...
    notusername: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Masukkan Username dengan Tepat!!'
    },
    notvalue: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Apikey Invalid, Need Apikey??Bisa Langsung Chat https://Wa.me/6282158549899'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
    ...
    notAddApiKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Harap isi data URL dengan Benar!!!'
    },
    error: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Akira'+'YT Akira';
...
router.get('/cekapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		...
		message: `Jangan lupa Follow Terus ${creator}`
	})
} else {
	json = JSON.stringify({
		status: false
...
router.get('/youtube/audio', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
            url = req.query.url
...
router.get('/youtube/search', async (req, res, next) => {
    ...
    if (!video) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter video"})
       ...
       fetch(encodeURI(`https://youtube-api-zaahirr.herokuapp.com/search?q=${video}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
